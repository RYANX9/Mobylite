...
export const API_ENDPOINTS = {
  ...
  phones: {
    ...
    stats: (id: number) => `/phones/${id}/stats`,  // Add this
    alsoCompared: (id: number) => `/phones/${id}/also-compared`,  // Add this
  },
  reviews: {
    base: "/reviews",
...
// Update createPhoneSlug to only use model_name
export const createPhoneSlug = (phone: Phone | { brand: string; model_name: string }) => {
...
// Update APP_ROUTES.compare to use slugs
