...
const ReviewForm: React.FC<ReviewFormProps> = ({ phoneId, onSuccess }) => {
  ...
  return (
    <div className="rounded-xl p-6 transition-all mb-8" style={cardStyle}>
      <div className="mb-4">
        <span
...
const ExpandableReviewCard: React.FC<ExpandableReviewCardProps> = ({
  ...
  if (isEditing) {
    return (
      <div className="rounded-xl p-6 transition-all" style={cardStyle}>
        <div className="mb-4">
          <span
            className="inline-block px-3 py-1.5 rounded-full text-xs font-bold"
            style={{ backgroundColor: color.primary, color: color.bg }}
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              style={{ accentColor: color.primary }}
            />
            <span className="text-sm font-medium" style={{ color: color.text }}>I own this phone</span>
          </label>
          ...
          <div className="flex gap-3">
            ...
            <ButtonPressFeedback
              ...
              style={{ backgroundColor: 'transparent', color: color.text, border: `1px solid ${color.border}` }}
            >
              Cancel
            </ButtonPressFeedback>
          </div>
      ...
      {isOwnReview && (
        <div className="mb-4 flex items-center justify-between">
          ...
          <ButtonPressFeedback
            ...
            style={{ backgroundColor: 'transparent', color: color.primary, border: `1px solid ${color.primary}` }}
          >
            Edit
          </ButtonPressFeedback>
        </div>
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="font-bold text-base" style={{ color: color.text }}>{displayName}</span>
          ...
          <p className="text-xs font-medium" style={{ color: color.textMuted }}>
            ...
            {review.edited_at && (
              <span className="ml-2 italic" style={{ color: color.textMuted }}>(Edited)</span>
            )}
          </p>
        </div>
...
export const ReviewSection: React.FC<ReviewSectionProps> = ({ phoneId }) => {
  ...
  const fetchReviews = async (currentUserId: string | null = userId) => {
    try {
      ...
      if (data?.helpful_review_ids?.length > 0) {
  ...
  return (
    <div className="space-y-8">
      ...
      {isAuthenticated() ? (
        <>
          {userReview ? (
            <ExpandableReviewCard review={userReview} isOwnReview={true} />
          ) : (
            <>
              {showForm ? (
                <ReviewForm phoneId={phoneId} onSuccess={() => fetchReviews()} />
              ) : (
                <ButtonPressFeedback
        ...
        <div className="rounded-2xl p-10 text-center" style={{ backgroundColor: color.bgInverse }}>
          <h3
      ...
      {topReviews.length > 0 && (
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            <h4 className="font-bold text-xl" style={{ color: color.text }}>Top Reviews</h4>
      ...
      {topReviews.length === 0 && !userReview && (
        ...
        >
          <p className="text-lg font-medium mb-2" style={{ color: color.text }}>No reviews yet</p>
