...
export default function LoginForm({ redirectUrl }: LoginFormProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: color.bg }}>
      {/* ✅ CHANGED: Use order classes for responsive layout */}
      <div className="flex flex-col lg:flex-row lg:h-screen">
        
        {/* Hero Section - Left on desktop, Bottom on mobile */}
        <div
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-40">
              ...
              <span 
                ...
                style={{ color: color.primaryText }} // Only keep the color inline
              > 
              Mobylite
              </span>
            </div>
            ...
            {/* Feature Icons - Minimal, white on dark */}
            ...
            <p className="max-w-md mb-10" style={{ color: color.textMuted }}>
