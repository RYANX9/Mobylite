      ...
      <div className="flex flex-col lg:flex-row lg:h-screen">
        ...
        <div className="order-1 lg:order-2 flex-1 flex items-center justify-center p-8 min-h-screen lg:min-h-0">
          <div className="w-full max-w-md space-y-6">
            ...
            {/* OVERLAY STRATEGY: Custom white button visible immediately, official GSI button invisible on top */}
            <div className="relative w-full h-12">
              <button
                type="button"
                disabled={loading}
                className="absolute inset-0 w-full h-full rounded-xl font-bold flex items-center justify-center gap-3 transition hover:bg-gray-50"
                style={{ 
                    border: `1px solid ${color.border}`,
                    backgroundColor: '#ffffff', // Custom white background
                    color: '#1f2937', // Custom dark text
                }}
              >
                <FcGoogle size={24} />
              ...
              <div 
                ...
                className="absolute inset-0 w-full h-full opacity-0 z-10 overflow-hidden"
              />
            </div>
